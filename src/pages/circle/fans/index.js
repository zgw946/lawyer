      ...
      <Fragment>
        <div className="fans">
          ...
          <div className="serach_fans">
            <span style={{ lineHeight: "50px", marginLeft: "20px", fontSize: "16px", color: "#333" }}>我的粉丝</span>
            ...
            <div key={item.id}>
              ...
              >
                ...
                <div style={{ marginTop: "6px",marginBottom:"10px" }}>
                  ...
                  <span className=" face"></span>
                  <p style={{ marginTop: "20px", color: "#333", fontSize: "12px", fontWeight: "bold", marginLeft: "64px" }}>专长：婚姻、刑事、劳动</p>
                  <Button style={{ width: "90px", backgroundColor: "#2e3341", marginLeft: "87px", color: "#fff" }}>互相关注</Button>
                </div>
              </Card>
            </div>
          ))}
